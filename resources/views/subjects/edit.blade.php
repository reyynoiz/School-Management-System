            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('subjects.update', $subject->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code" id="code" placeholder="Contoh: MTK-01" value="{{ old('code', $subject->code) }}" autofocus required
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" placeholder="Contoh: Matematika" value="{{ old('name', $subject->name) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
